...
set -e
LOGFILE=/home/philippe/projeto/api-django/Api-chat/logs/gunicorn.log
...
source /home/philippe/projeto/lib/activate
cd /home/philippe/projeto/api-django/Api-chat/
test -d $LOGDIR || mkdir -p $LOGDIR
exec gunicorn -w $NUM_WORKERS --bind=$ADDRESS --user=$USER --log-level=debug --log-file=$LOGFILE 2>>$LOGFILE scrum.wsgi:application
